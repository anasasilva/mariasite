...
function CustomNavbar(props) {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className={"ml-auto " + (darkNavBar ? " white" : " black")}>
      <Nav.Link className={"mr-3 " + (darkNavBar ? " white" : " black")} href="/"><h5 className={"text-font mb-0 " + (props.home ? "underline" : "") + (darkNavBar ? " white" : " black")}>{t('navbar.home')}</h5></Nav.Link>
      ...
      <NavDropdown title={<h5 className={"text-font mb-0 my-auto d-inline" + (darkNavBar ? " white" : " black")}>{t('navbar.language')}</h5>} id="basic-nav-dropdown">
